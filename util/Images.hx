...
@:bitmap("assets/img/Blue.png")				class BmBlue extends BMData{}
...
@:bitmap("assets/img/Move.png")				class BmMove extends BMData{}
...
@:bitmap("assets/img/Background.png")		class BmBluePaper extends BMData{}
@:bitmap("assets/img/BackgroundMenu.png")	class BmBackgroundMenu extends BMData{}
@:bitmap("assets/img/Etiquette.png")		class BmEtiquette extends BMData{}
@:bitmap("assets/img/Etiquette Large.png")	class BmEtiquetteLarge extends BMData{}
@:bitmap("assets/img/Rivet.png")			class BmRivet extends BMData{}
@:bitmap("assets/img/GreenPaperSmall.png")	class BmGreenPaperSmall extends BMData{}
@:bitmap("assets/img/RedPaperSmall.png")	class BmRedPaperSmall extends BMData{}
@:bitmap("assets/img/View.png")				class BmView extends BMData{}
@:bitmap("assets/img/apply.png")			class BmApply extends BMData{}
...
@:bitmap("assets/img/LED Off.png")			class BmLedRedSteel extends BMData{}
...
@:bitmap("assets/img/Help.png")				class BmHelp extends BMData { }
...
class BMData extends BitmapData
{
	...
	public function new(transparent:Bool=true, fillColor:UInt=0xFFFFFFFF) 
	{
...
class Images
{
	...
	function imgloader_completed(evt:Event):Void
	{
		...
		Main.root1.dispatchEvent(new Event(PanelEvents.EVT_IMAGES_LOADED));
	}
	...
	public static function loadBlue():				Bitmap{return new BitmapSmoothed(new BmBlue());}
	...
	public static function loadClock():				Bitmap{return new BitmapSmoothed(new BmLoadClock());}
	...
	public static function loadMove():				Bitmap{return new BitmapSmoothed(new BmMove());}
	...
	public static function loadBackground():		Bitmap{return new BitmapSmoothed(new BmBluePaper());}
	public static function loadBackgroundMenu():	Bitmap{return new BitmapSmoothed(new BmBackgroundMenu());}
	public static function loadFillEtiquette():		Bitmap{return new BitmapSmoothed(new BmEtiquette());}
	public static function loadFillEtiquetteLarge():Bitmap{return new BitmapSmoothed(new BmEtiquetteLarge());}
	public static function loadView(i:Bool):		Bitmap{return new BitmapGlyph(new BmView(), i);}
	public static function loadApply():				Bitmap{return new BitmapSmoothed(new BmApply());}
	...
	public static function loadLEDRedSteel(?i:Bool):Bitmap{return new BitmapGlyph(new BmLedRedSteel(), i);}
	...
	public static function loadHelp():				Bitmap{return new BitmapGlyph(new BmHelp());}
	 ...
	 * @return
	 */
	public static function resize(source:Bitmap, width:Int, ?height:Int) : Void
	{
