 ...
 * @author lastdance
 */
class RPMLaf1 extends BasicLookAndFeel{
	...
	private override function initClassDefaults(table:UIDefaults):Void{
	...
	private override function initSystemColorDefaults(table:UIDefaults):Void{
		var defaultSystemColors:Array<Dynamic>= [
			"window", ASColor.CLOUDS.getRGB(), // 0xe6e6e6,  //window panel background color
			"windowText", ASColor.CLOUDS.getRGB(), //0xFFFFFE, /* ??? */
			...
			"controlText", ASColor.CLOUDS.getRGB(), //0x4d4d4d, /* Default color for text in controls */				
		...
		table.set("selectionBackground", new ASColorUIResource(0xa0b7c8, 0.9));
		//table.set("focusInner", new ASColorUIResource(0xa0b7c8, 0.3));
		//table.set("focusOutter", new ASColorUIResource(0xa0b7c8, 0.4));
        table.set("focusInner", new ASColorUIResource(0x40FF40, 0.3));
        table.set("focusOutter", new ASColorUIResource(0x40FF40, 0.4));
	}
	
	private override function initSystemFontDefaults(table:UIDefaults):Void {

		var defaultSystemFonts:Array<Dynamic>= [
			"systemFont", new ASFontUIResource(DEFFONT, 14, false), 
			"menuFont", new ASFontUIResource(DEFFONT, 14, false), 
			"controlFont", new ASFontUIResource(DEFFONT, 14, false), // GM
			"labelFont", new ASFontUIResource(DEFFONT, 14, false), // GM
			"windowFont", new ASFontUIResource(DEFFONT, 14, false)
		];
		table.putDefaults(defaultSystemFonts);
	}
	
	private override function initCommonUtils(table:UIDefaults):Void{
	...
	private override function initComponentDefaults(table:UIDefaults):Void{
		var buttonBG:ASColorUIResource = new ASColorUIResource(0xa0b7c8); // GM
		...
		var comDefaults:Array<Dynamic>= [
			...
			"Button.foreground", ASColor.CLOUDS.getRGB(), //new ASColorUIResource(0xFFFFFE),
		...
		comDefaults = [
			...
			"LabelButton.foreground", ASColor.CLOUDS.getRGB(), // new ASColorUIResource(0xa0b7c8), 
			...
			"LabelButton.font", table.getFont("labelFont"),
			"LabelButton.margin", new InsetsUIResource(0, 0, 0, 0), 
			"LabelButton.textShiftOffset", 1 ,
		...
		comDefaults = [
			...
			"TextField.mideground", new ASColorUIResource(0xa0b7c8), 
		...
		comDefaults = [
			...
			"ProgressBar.mideground", new ASColorUIResource(0xa0b7c8), 
			...
			"ProgressBar.font", new ASFontUIResource(DEFFONT, 20), 
	   ...
	   // *** TextArea
		comDefaults = [
			...
			"TextArea.mideground",  new ASColorUIResource(0xa0b7c8), 
		...
		comDefaults = [
			...
			"Frame.mideground", new ASColorUIResource(0xa0b7c8), // Title Bar Color
		...
		// *** FrameTitleBar
		comDefaults = [
			"FrameTitleBar.background", new ASColorUIResource(0xaec2d1),
			"FrameTitleBar.foreground", new ASColorUIResource(0x0084ad), 
			"FrameTitleBar.mideground", new ASColorUIResource(0xa0b7c8), // GM
			...
			"FrameTitleBar.bg", new ASColorUIResource(0xa0b7c8), // GM
		...
		comDefaults = [
			...
			"ComboBox.mideground", new ASColorUIResource(0xa0b7c8), 
		...
		comDefaults = [
			...
			"Adjuster.mideground", new ASColorUIResource(0xa0b7c8), 
		...
		comDefaults = [
			...
			"Stepper.mideground", new ASColorUIResource(0xa0b7c8), 
	   ...
	   // *** JTabbedPane
		comDefaults = [
			...
			"TabbedPane.mideground", new ASColorUIResource(0x9AB3C5), 
			"TabbedPane.colorAdjust", new UIStyleTune(0.2, -0.40, 0.01, 0.50, 4, new UIStyleTune(0.05, -0.23, 0.01, 0.50, 4)), 
